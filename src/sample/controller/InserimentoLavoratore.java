...
import sample.utils.IdCreation;
...
public class InserimentoLavoratore implements Initializable {
    ...
    public void setComboBoxData() throws SQLException {
        ...
        try {
            ...
            Logger.getLogger(InserimentoLavoratore.class.getName()).log(Level.SEVERE,null, e);
            e.printStackTrace();
        }
    }
    ...
    // Controllo che data2 sia maggiore di data1 (di un singolo comune)
    ...
    public void creazioneAnagrafica(ActionEvent actionEvent)throws IOException{
        ...
        if( Nome.getText().isBlank() || !soloLettere(Nome.getText()) || Cognome.getText().isBlank() ||
            ...
            IdCreation creazioneId = new IdCreation();
            String idLavoratore = creazioneId.createUniqueID() ;
            ...
            lavoratore.setIdLavoratore(idLavoratore);
